...
export const systemInfo = [
  ...
  { key: 'SPECIALTY', value: 'Full Stack Development' },
  { key: 'FOCUS', value: 'Scalable Web Applications' },
  { key: 'ARCHITECTURE', value: 'Clean Architecture / MVC' },
  { key: 'DATABASES', value: 'MongoDB / PostgreSQL / Firebase' },
];
